...
RSpec.describe AnswersController, type: :controller do
    ...
    context 'when user is authenticated' do
      context 'and user is author' do
        ...
        it 'does not save the vote yes' do
          expect { patch :vote_yes, params: { id: answer }, format: :json }.to_not change(Vote, :count)
        end
      end
      ...
      context 'and user is not an author' do
        ...
        it 'saves the vote yes' do
          expect { patch :vote_yes, params: { id: answer }, format: :json }.to change(Vote, :count).by(1)
        end

        it 'renders empty json' do
          patch :vote_yes, params: { id: answer }, format: :json
    ...
    context 'when user is authenticated' do
      context 'and user is author' do
        ...
        it 'does not save the vote no' do
          expect { patch :vote_no, params: { id: answer }, format: :json }.to_not change(Vote, :count)
        end
      end
      ...
      context 'and user is not an author' do
        ...
        it 'saves the vote no' do
          expect { patch :vote_no, params: { id: answer }, format: :json }.to change(Vote, :count).by(1)
        end

        it 'renders empty json' do
          patch :vote_no, params: { id: answer }, format: :json
          expect(response).to be_successful
        end
  ...
  describe 'PATCH #cancel_vote' do
    #let!(:user) { create(:user) }
    #let!(:question) { create(:question) }
    before(:each) { user.votes.create(votable: answer) }
    ...
    context 'when user is authenticated' do
      context 'and user is author' do
        ...
        it 'does not cancel vote' do
          expect { patch :cancel_vote, params: { id: answer }, format: :json }.to_not change(Vote, :count)
        end
      end
      ...
      context 'and user is not an author' do
        ...
        it 'cancel vote' do
          expect { patch :cancel_vote, params: { id: answer }, format: :json }.to change(Vote, :count).by(-1)
        end

        it 'renders empty json' do
          patch :cancel_vote, params: { id: answer }, format: :json
          expect(response).to be_successful
        end
